document.addEventListener('DOMContentLoaded', () => {
    ...
    document.addEventListener('mousemove', (e) => {
        ...
        fluidCursor.inputManager.updatePointerPosition("mouse", e.clientX, e.clientY);
    });
        ...
        if (event.data && event.data.mode === "eye-gaze") {
            ...
            if (!hidden) {
                ...
                if (iframe) {
                    ...
                    const fullScreenY_screen = y * screen.height;
                    ...
                    // Fallback to full screen coordinates
                    eyeGazeX = x * screen.width;
                    eyeGazeY = y * screen.height;
                }
                
                // Use eye gaze exactly like mouse cursor (use mouse input strategy)
                fluidCursor.inputManager.updatePointerPosition("mouse", eyeGazeX, eyeGazeY);
            }
        }
    });
});